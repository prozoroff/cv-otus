...
Полученную на выходе модели разница просто суммируем с исходным изображением и получаем предсказание, которое можно сравнить с реальными данными за более поздний срок.
